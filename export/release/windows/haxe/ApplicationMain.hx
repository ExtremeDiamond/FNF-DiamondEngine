...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("DiamondEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("DiamondEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "13";
		app.meta["company"] = "ExtremeDiamond";
		app.meta["file"] = "DiamondEngine";
		app.meta["name"] = "Friday Night Funkin': Diamond Engine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Diamond Engine",
			width: 1280,
			x: null,
			y: null,
		};
